# predict_realtime_resnet101.py

# PyTorch deep learning framework
import torch
# Neural network modules from PyTorch
import torch.nn as nn
# Import ResNet101 model architecture and weights
...
def load_model(model_path):
    ...
    # 1. Initialize the ResNet101 model architecture without pretrained weights
    #    This is the key change from ResNet50 to ResNet101.
    model = resnet101(weights=None)
    
    # Get the number of input features for the final fully connected layer
    num_ftrs = model.fc.in_features
    
    # 2. Recreate the exact same custom classifier structure used during training
...
def main():
    ...
    """
    # 3. Path updated to the trained ResNet101 model checkpoint
