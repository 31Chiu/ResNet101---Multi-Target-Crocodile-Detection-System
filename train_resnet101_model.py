...
class ResNet101Trainer:
    ...
    def _build_transforms(self):
        ...
        # Transformations for the training data to introdice variability
        ...
        # Transformation for the validation data (no augumentation)
    ...
    def _build_model(self):
        # Build the ResNet101 model using transfer learning
